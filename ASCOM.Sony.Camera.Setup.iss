...
; Generated by Alexey Sobolev on 02.10.2019 (UTC)
;
[Setup]
...
OutputDir="."
OutputBaseFilename="ASCOM.Sony.Camera.Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Camera\ASCOM.Sony.Camera"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Camera\ASCOM.Sony.Camera"
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Sony.Camera.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Sony.Camera.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Sony.Camera.dll"""; Flags: runhidden 64bit; Check: IsWin64
